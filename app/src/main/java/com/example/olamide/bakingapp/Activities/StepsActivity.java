...
import com.example.olamide.bakingapp.databinding.ActivityStepViewpagerBinding;

import java.util.ArrayList;

public class StepsActivity extends AppCompatActivity {
    private static final String BUNDLE_STEP_DATA =
            "com.example.olamide.bakingapp.step_data";
    private static final String BUNDLE_CURRENT_RECIPE =
            "com.example.olamide.bakingapp.current_recipe";
    private static final String BUNDLE_CURRENT_STEP =
            "com.example.olamide.bakingapp.current_step";
